...
//     endTransaction();
// #endif // !defined(RF24_LINUX)
//     IF_SERIAL_DEBUG(printf_P(PSTR("read_register(%02x) = %02x\r\n"), reg, result));
//     return result;
// }
...
//     {
//         if (reg != RF24_NOP)
//         { // don't print the get_status() operation
...
//     printf_P(PSTR("Waiting for wireless chip to configure\r\n"));
...
// #if defined(SERIAL_DEBUG)
//     printf_P(PSTR("Setting wireless data rate\r\n"));
// #endif
...
//     Serial.println(_BV(EN_CRC) | _BV(CRCO) | _BV(PWR_UP), BIN);
//     Serial.println(_BV(EN_CRC), BIN);
//     Serial.println(_BV(CRCO), BIN);
//     Serial.println(_BV(PWR_UP), BIN);
// #endif
